...
class Provider:
    ...
    def k8s_execution_order(self) -> List[PulumiProject]:
        ...
        return [
            ...
            PulumiProject(path='kubernetes/threatstack', description='ThreatStack',
                          config_keys_with_secrets=[SecretConfigKey(key_name='threatstack:agentDeployKey',
                                                                    prompt='Threatstack deployment key')]),
